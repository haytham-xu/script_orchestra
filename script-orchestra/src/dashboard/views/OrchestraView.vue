...
<style scoped>
.lp { min-height: 100vh; padding: 32px; box-sizing: border-box; }
.lp-grid {
  display: flex;
  flex-wrap: wrap;
...
.lp-folder-panel { background: rgba(255,255,255,0.92); border-radius: 20px; padding: 24px 28px;
  margin-bottom: 285px;   /* shift the panel up by ~1.5 icon heights */
  min-width: 900px; max-width: 80vw; max-height: 80vh; overflow: auto;
...
.lp-folder-grid { display: grid; grid-template-columns: repeat(auto-fill, 190px); gap: 24px; }
.lp-folder-remove {
