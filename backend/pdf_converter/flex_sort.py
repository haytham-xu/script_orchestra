...
This is an independent copy of basic/flex_sort.py specifically for the pdf_converter module.
DO NOT modify this file when working on other modules.
This ensures pdf_converter remains stable without E2E test coverage.

If you need to modify sorting behavior in other modules, edit basic/flex_sort.py instead.
"""
